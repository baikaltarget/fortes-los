...
Next.js 14 (App Router) + Tailwind, статическая генерация, формы → Telegram. 300 страниц. Домен: `fortes-group.ru`.

## 0. Что изменилось в v27 — раздел «Электрика» стал живым
...
## 0а. Что изменилось в v26 — SEO-чистка: title/description, хаб водоснабжения, перелинковка блога
...
## 0б. Что изменилось в v25 — раздел «Водоснабжение» стал живым
...
## 0в. Что изменилось в v23 — раздел «Бурение» стал живым
