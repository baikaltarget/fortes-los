  ...
  return (
    <>
      <div className="container-site">
        ...
        <div className="mt-6 flex flex-wrap gap-2"><a href="#otoplenie" className="chip hover:border-ink">Отопление</a><a href="#burenie" className="chip hover:border-ink">Бурение</a><a href="#kanalizaciya" className="chip hover:border-ink">Канализация</a></div>
