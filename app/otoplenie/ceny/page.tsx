...
export const metadata = meta({
  ...
  description: "Стоимость отопления дома в Иркутске: дом 120 м² под ключ — 470 680 ₽, радиаторы под ключ от 2 500 ₽/м², тёплый пол от 4 500 ₽/м², котельная от 50 000 ₽. Шесть реальных смет.",
  path: HP.ceny,
});
  ...
  return (
    <>
      <div className="container-site">
        ...
        <p className="mt-4 text-[18px] text-ink/85 max-w-[62ch]">Главные цифры — под ключ с котлом, всеми материалами и работой: радиаторы от 2 500 ₽/м², тёплый пол от 4 500 ₽/м². Дом 120 м² с тёплым полом и котельной в Бурдаковке — 470 680 ₽. Ниже ориентиры по видам работ и шесть реальных смет, чтобы было с чем сравнить.</p>
