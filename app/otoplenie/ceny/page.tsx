...
export const metadata = meta({
  ...
  description: "Стоимость отопления дома в Иркутске: дом 120 м² под ключ — 470 680 ₽, тёплый пол от 2 500 ₽/м², котельная от 150 000 ₽, радиатор от 6 000 ₽/точка. Шесть реальных смет.",
  path: HP.ceny,
});
