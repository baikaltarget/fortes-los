...
export const metadata = meta({
  ...
  description: "Сколько стоит электромонтаж в частном доме в Иркутске: точка от 1 200 ₽, щит 380 В от 45 000 ₽, ввод СИП от 18 000 ₽, заземление от 18 000 ₽. Дом 120 м² — от 180 000 ₽.",
  path: EP.ceny,
});
  ...
  return (
    <>
      <div className="container-site">
        ...
        <p className="mt-4 text-[18px] text-ink/85 max-w-[62ch]">Главные цифры — от 1 200 ₽ за точку в газобетоне и каркасе, от 1 800 ₽ в брусе, дом 120 м² под ключ — от 180 000 ₽. Ниже — ориентиры по всем видам работ.</p>
