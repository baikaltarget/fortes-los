  ...
  return (
    <>
      ...
      <section className="py-12 md:py-16"><div className="container-site prose-site">
        ...
        <h2>Сроки {g.prep}</h2>
        <p>Выезд инженера — 1–3 дня. Novo Eko 3, Novo Eko 5 и Zörde 4 в сезон есть на складе в Иркутске — ждать доставку не нужно; остальные модели едут с завода около 3 недель. Монтаж — 1–2 дня. Обслуживание и гарантия — наша бригада в Иркутске, {g.distance} до вас.</p>
      </div></section>
