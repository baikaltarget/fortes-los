...
export default function Page({ params }: { params: { slug: string } }) {
  ...
  return (
    <>
      <JsonLd data={ldProduct({ name: `${p.name} под ключ`, description: p.summary, path: P.product(p.slug), price: turnkeyFrom(p), brand: b.name, image: p.image })} />
        ...
        <div className="grid gap-5 lg:grid-cols-[1fr_1fr]">
          <div className="card p-6 md:p-8 shadow-card">
            ...
            <div className="mt-6 flex flex-wrap gap-2">
              ...
              <Link href="/kanalizaciya/septik-v-rassrochku/" className="btn-outline">В рассрочку или кредит</Link>
            </div>
          </div>
