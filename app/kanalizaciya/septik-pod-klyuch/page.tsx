...
/** Бывшая главная (v1–v27) под запрос «септик под ключ иркутск». С v28 корень `/` — главная бренда, эта страница живёт здесь. */
...
export default function Page() {
  ...
  return (
    <>
      ...
      <div className="container-site"><Breadcrumbs items={[{ name: "Канализация", href: P.hub }, { name: "Септик под ключ", href: SEPTIK_PATH }]} /></div>
      ...
      <Steps />
      <LeadSection source="септик под ключ" />
