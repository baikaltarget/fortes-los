...
import { VODA, vodaObjects, rub, VP, pickObjects } from "@/lib/content";
...
const faq = [
  ...
  { q: "Что может увеличить стоимость?", a: "Сшитый полиэтилен PEX вместо полипропилена, бесшумная канализация в спальной зоне, длинные наружные трассы, свайный фундамент (утеплённые подъёмы с кабелем), зимний монтаж наружных сетей с отогревом, встраиваемые смесители и инсталляции, водоочистка по анализу." },
