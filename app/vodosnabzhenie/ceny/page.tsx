...
export const metadata = meta({
  title: "Цены на водоснабжение и канализацию в частном доме, Иркутск 2026 — стоимость за точку и метр | Фортес",
  description: "Сколько стоит провести воду и канализацию в частный дом в Иркутске: точка воды от 4 500 ₽, точка канализации от 3 500 ₽, ввод от 1 800 ₽/м, коллектор от 25 000 ₽, бойлер, гидроаккумулятор, подключение к Водоканалу. Дом 120 м² — от 250 000 ₽. Реальные объекты с ценами.",
  path: VP.ceny,
});
