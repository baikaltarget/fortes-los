...
export const metadata = meta({
  ...
  description: "Стоимость скважины на воду в Иркутске: от 2 500 ₽ за метр сталью, металл + пластик от 2 900 ₽/м, кессон от 90 000 ₽, насос с монтажом от 25 000 ₽. Три реальные сметы с объектов.",
  path: BP.ceny,
});
  ...
  return (
    <>
      <div className="container-site">
        ...
        <p className="mt-4 text-[18px] text-ink/85 max-w-[62ch]">Главная цифра — от 2 500 ₽ за метр с обсадкой, прокачкой и паспортом. Ниже — ориентиры по конструкциям и обустройству и три реальные сметы, чтобы было с чем сравнить.</p>
