...
export const metadata = meta({
  title: "Цены на бурение скважин в Иркутске 2026 — стоимость метра, кессон, насос, ввод в дом | Фортес",
  description: "Стоимость бурения скважины на воду в Иркутске: от 2 300 ₽ за метр сталью, металл + пластик от 2 900 ₽/м, кессон от 90 000 ₽, адаптер от 45 000 ₽, насос с монтажом от 25 000 ₽, ввод в дом от 1 800 ₽/м. Три реальные сметы с объектов.",
  path: BP.ceny,
});
