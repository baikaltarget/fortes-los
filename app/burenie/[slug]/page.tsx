...
export function generateMetadata({ params }: { params: { slug: string } }) {
  ...
  if (g) return meta({
    ...
    description: `Бурение скважин ${g.prep}: вода на ${g.depth}, грунт — ${g.soil}. От 2 500 ₽ за метр, кессон, насос, ввод в дом. Гарантия 5 лет, инженер бесплатно.`,
    path: BP.geo(g.slug),
  });
  return {};
}
