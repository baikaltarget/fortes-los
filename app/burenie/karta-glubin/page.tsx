...
const faq = [
  { q: "Откуда данные на карте?", a: "Это наши скважины с 2014 года и данные соседних скважин, которые мы замеряли при обустройстве и ремонте. Точки на карте — реальные объекты с глубиной и конструкцией." },
