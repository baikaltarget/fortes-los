...
import { products, brands, productsByBrand } from "@/lib/content";
  ...
  return (
    <>
      <div className="container-site">
        <Breadcrumbs items={[{ name: "Станции", href: "/stancii/" }]} />
        ...
        <section key={b.slug} className="py-10 md:py-14">
          <div className="container-site">
            <div className="flex flex-wrap items-baseline justify-between gap-3 mb-6">
              <h2>{b.name}</h2>
              <Link href={`/${b.slug}/`} className="text-brand underline underline-offset-2 text-[15px]">О линейке {b.name}</Link>
            </div>
      ...
      <section className="py-6"><div className="container-site card p-6 md:p-8">
        ...
        <p className="mt-2 text-ink/80 max-w-[70ch]">Kolo Vesi 10, 15, 20, 30, 40, 50, 60 и станции Kolo Ilma на 15–100 м³ в сутки — под запрос. Смотрите <Link href="/kanalizaciya-dlya-poselka/" className="text-brand underline">канализацию для посёлка и турбазы</Link>.</p>
      </div></section>
      <FAQ items={faq} />
