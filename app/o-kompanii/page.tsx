      ...
      <div className="container-site">
        ...
        <div className="mt-6 grid gap-8 lg:grid-cols-[1.2fr_1fr]">
          <div className="prose-site">
            ...
            <p>Канализацию мы начинали как дополнение к водоснабжению, а сейчас это отдельное направление: официальное дилерство завода Kolo Vesi (станции Kolo Vesi, Novo Eko, Zörde, Kolo Ilma) и завода Экомир (кессоны, ёмкости, септики «Дача»).</p>
