      ...
      <div className="container-site">
        ...
        <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
          {services.filter((s) => s.slug !== exclude).map((s) => (
            <Link key={s.slug} href={P.page(s.slug)} className="card px-5 py-4 font-medium hover:shadow-card border border-transparent hover:border-line flex items-center justify-between gap-3">
